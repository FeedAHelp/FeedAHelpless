    ...
    <Styled.PickACard>
        <Styled.RadioTileGroup>
            <Styled.InputContainer>
                <Styled.InputRadio id="visa" type="radio" name="radio" value="visa" onClick={(e) => { changeCardBackground(e)}} checked />
                <Styled.InputRadioLite>
                    <div className="icon bike-icon">
                        <Image src={"/static/images/payment/visa.png"} width={40} height={40} alt="visa" />
                    </div>
                </Styled.InputRadioLite>
            </Styled.InputContainer>

            <Styled.InputContainer>
                <Styled.InputRadio id="master" type="radio" name="radio" value="master" onClick={(e) => { changeCardBackground(e)}} />
                <Styled.InputRadioLite>
                    <div className="icon car-icon">
                        <Image src={"/static/images/payment/master.png"} width={30} height={30} alt="visa" />
                    </div>
                </Styled.InputRadioLite>
            </Styled.InputContainer>
        </Styled.RadioTileGroup>
